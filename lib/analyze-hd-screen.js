...
const schema = {
  ...
  required: [
    ...
    "suggestedDepartment", "departmentConfidence", "visibleText", "summary"
  ]
};
...
function normalizeComparable(value) {
  return String(value || "").trim().replace(/\s+/g, " ").normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLocaleLowerCase("fr-CA");
}
...
Réponds strictement selon le schéma JSON demandé.`
    ...
    text: { format: { type: "json_schema", name: "home_depot_screen_extraction", strict: true, schema } }
  };
